package com.pigdogbay.swiftnotes;
...
import com.pigdogbay.swiftnotes.model.Note;
import com.pigdogbay.swiftnotes.model.NoteData;
...
public class NoteListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new NoteArrayAdapter(NoteData.NOTES));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(NoteData.NOTES.get(position).toString());
    }
    ...
    private class NoteArrayAdapter extends ArrayAdapter<Note> {
        ...
        public NoteArrayAdapter(List<Note> objects) {
            super(getActivity(), android.R.layout.simple_list_item_activated_1,
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            String title = getActivity().getString(getItem(position).getTitleId());
